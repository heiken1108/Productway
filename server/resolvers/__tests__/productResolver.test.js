...
describe('ProductResolver', () => {
    describe('getRandomItem', () => {
        it('Should return the one product in the database', async () => {
            ...
            const isTestProduct = testProduct.some((testProduct) => testProduct.name === result.name)
            const isTestProductID = testProduct.some((testProduct) => testProduct.productID === result.productID)
    ...
    describe('getProductByProductID', () => {
        it('Should return products based on productID', async () => {
            ...
            const result1 = await productQuery.getProductByProductID(null, { productID: 1 });
            const result2 = await productQuery.getProductByProductID(null, { productID: 2 });
    ...
    describe('getProductsBySearch', () => {
        it('Return products based on searchteerm' , async () => {
            ...
            const result1 = await productQuery.getProductsBySearch(null, { search: "Brun" });
            const result2 = await productQuery.getProductsBySearch(null, { search: "Brune" });
    ...
    describe('getProductsByFiltersWithLimit', () => {
        it("Should return products based on filters/categories", async () => {
            const testProducts = [
              ...
              const result1 = await productQuery.getProductsByFiltersWithLimit(null, {
                searchTerm: '',
                categories: '',
                minPrice: 0,
                maxPrice: 200,
              ...
              const result2 = await productQuery.getProductsByFiltersWithLimit(null, {
                searchTerm: '',
              ...
              const result3 = await productQuery.getProductsByFiltersWithLimit(null, {
                searchTerm: '',
                categories: 'Test Category 2',
                minPrice: 30,
                maxPrice: 200,
              ...
              const result4 = await productQuery.getProductsByFiltersWithLimit(null, {
                searchTerm: '',
                categories: 'Test Category 2',
                minPrice: 30,
                maxPrice: 90,
